		...
		data () {
			return {
				...
				list: [
					...
					{
						img_url: require('./img/15.jpeg'),
						title: '这是标题这是标题这是标题这是标题这是标题',
						desc: '这是商品的描述这是商品的描述这是商品的描述这是描述这是商品的描述',
						price: 16.5,
					},
					{
						img_url: require('./img/1.jpg'),
						title: '这是标题这是标题这是标题这是标题这是标题这是题这是标题',
						desc: '这是商品的描述这是商品的描述这是商品的描述品这是商品的描述',
						price: 16.5,
					},
					{
						img_url: require('./img/1.jpg'),
						title: '这是题这是标题',
						desc: '这是商品的描述这是商品的描述这是商品的描述这述这是商品的描述',
						price: 16.5,
					},
				]
			}
